<%--<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/WarehouseMaster.Master" AutoEventWireup="true" CodeBehind="DefaultPalletAgingReport.aspx.cs" Inherits="PDCSReporting.DefaultPalletAgingReport" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
   <div class="container-fluid">
        <div class="page-header" style="padding-top:80px;">
            <h1 style="font-family: Georgia; color: #da532c;">Default Pallet Aging Report</h1>
        </div>
        <div class="row">
