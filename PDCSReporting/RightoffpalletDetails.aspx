<%--<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/WarehouseMaster.Master" AutoEventWireup="true" CodeBehind="RightoffpalletDetails.aspx.cs" Inherits="PDCSReporting.RightoffpalletDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="page-header" style="padding-top:80px;">
            <h1 style="font-family: Georgia; color: #da532c;">Right Off Pallet Details</h1>
        </div>
        <div class="row">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #da532c;">
                    ...
                    <h3 class="modal-title" style="font-family: Georgia; color: white; font-weight: 500">Right Off PalletDetails</h3>
                </div>
