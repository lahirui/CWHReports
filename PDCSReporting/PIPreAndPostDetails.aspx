<%@ Page Language="C#"  MasterPageFile="~/MasterPages/WarehouseMaster.Master" AutoEventWireup="true" CodeBehind="PIPreAndPostDetails.aspx.cs" Inherits="PDCSReporting.PIPreAndPostDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function LoadSelect2() {
               $("#<%=ddlFromPI.ClientID%>").select2({
                placeholder: "Select PI",
                allowClear: true
               });
             $("#<%=ddlToPI.ClientID%>").select2({
                placeholder: "Select PI",
                allowClear: true
             });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="page-header" style="padding-top:80px;">
            <h1 style="font-family: Georgia; color: #da532c;">PI Pre And Post Count Details</h1>
        </div>
        <div class="row">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #da532c;">
                    ...
                    <h3 class="modal-title" style="font-family: Georgia; color: white; font-weight: 500">PI Pre And Post Count Details</h3>
                </div>
                        ...
                        <ContentTemplate>
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-4" for="cpo" style="font-family: Georgia">PI From:</label>
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlFromPI" style="width:300px" runat="server"  AppendDataBoundItems="true" CssClass="form-control"></asp:DropDownList>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlToPI" style="width:300px" runat="server"  CssClass="form-control" OnDataBound="ddlToPI_DataBound"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlFromLocation" style="width:300px" runat="server"  AppendDataBoundItems="true" CssClass="form-control"></asp:DropDownList>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            <label class="control-label col-md-3" for="so" style="font-family: Georgia">To:</label>
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlToLocation" style="width:300px" runat="server"  CssClass="form-control" OnDataBound="ddlToLocation_DataBound"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                </div>
