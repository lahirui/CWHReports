...
{
    public partial class AODUnavailableQuantities : System.Web.UI.Page
    {
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportDesigns/AODUnavailableQuantities.rdlc");
            AODUnavailableQuantitiesDS data = db.getAODReceiveDetails(AODId);
            ReportDataSource dts = new ReportDataSource("AODUnavailableQuantitiesDS", data.Tables[0]);
