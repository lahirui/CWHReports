...
{
    public partial class BSScannedBoxDetails : System.Web.UI.Page
    {
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            rvTeamOutput.LocalReport.ReportPath = Server.MapPath("~/ReportDesigns/BSScannedBoxDetailsDS.rdlc");
            BSScannedBoxDetailsDS output = dba.getDetailForBSScannedBoxDetails(dateFrom, dateTo);
            ReportDataSource ds = new ReportDataSource("BSScannedBoxDetailsDS", output.Tables[0]);
