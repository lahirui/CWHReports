<%@ Page Language="C#" MasterPageFile="~/MasterPages/WarehouseMaster.Master" AutoEventWireup="true" CodeBehind="ShipmentDetails.aspx.cs" Inherits="PDCSReporting.ShipmentDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="page-header" style="padding-top:80px;">
            <h1 style="font-family: Georgia; color: #da532c;">Shipment Details</h1>
        </div>
        <div class="row">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #da532c;">
                    ...
                    <h3 class="modal-title" style="font-family: Georgia; color: white; font-weight: 500">Shipment Details</h3>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlFromFactory" style="width:300px" runat="server" AppendDataBoundItems="true" CssClass="form-control" Enabled="false"></asp:DropDownList>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlToFactory" style="width:300px" runat="server" CssClass="form-control" OnDataBound="ddlToFactory_DataBound" Enabled="false"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlFromAOD" style="width:300px" runat="server"  AppendDataBoundItems="true" CssClass="form-control" Enabled="false"></asp:DropDownList>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            <label class="control-label col-md-3" for="so" style="font-family: Georgia">To:</label>
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlToAOD" style="width:300px" runat="server"  CssClass="form-control" OnDataBound="ddlToAOD_DataBound" Enabled="false"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlFromCPO" style="width:300px" runat="server"  AppendDataBoundItems="true" CssClass="form-control" Enabled="false"></asp:DropDownList>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            <label class="control-label col-md-3" for="so" style="font-family: Georgia">To:</label>
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlToCPO" style="width:300px" runat="server"  CssClass="form-control" OnDataBound="ddlToCPO_DataBound" Enabled="false"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                </div>
