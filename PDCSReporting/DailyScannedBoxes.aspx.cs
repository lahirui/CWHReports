...
{
    public partial class DailyScannedBoxes : System.Web.UI.Page
    {
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            rvTeamOutput.LocalReport.ReportPath = Server.MapPath("~/ReportDesigns/DailyScannedBoxesDS.rdlc");
            DailyScannedBoxesDS output = dba.getDetailForDailyScannedBoxes(dateFrom, dateTo);
