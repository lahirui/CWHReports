    ...
    public partial class ShipmentDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                dsAOD = com.ReturnDataSet("SELECT AODNumber FROM AODs WHERE(DstinationWarehouse LIKE 'SHIPMENT') " +
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            string toFactory = "SHIPMENT";// ddlToFactory.SelectedItem.Text;
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportDesigns/ShipmentDetails.rdlc");
            ShipmentDetailsDS output = dba.getShipmentDetails(dateFrom, dateTo, fromFactory, toFactory, fromAOD, toAOD, fromCPO, toCPO,factoryName);
            ReportDataSource ds = new ReportDataSource("ShipmentDetailsDS", output.Tables[0]);
