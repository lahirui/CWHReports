            ...
            <div class="row col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
                ...
                <div class="col-sm-2 col-md-2 col-lg-2 ">
                    <div class="list-group" style="border-color: #da532c; color: whitesmoke">
                        ...
                        <a href="LocationDetails.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-color: #da532c; border-bottom-width: 3px;  border-right-color: #da532c; border-right-width: 3px; border-left-color: #da532c; border-left-width: 3px;">
