                ...
                <div class="col-sm-2 col-md-2 col-lg-2 ">
                    <div class="list-group" style="border-color: #da532c; color: whitesmoke">
                      ...
                      <%--  <a href="DailyScannedBoxesOldStock.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-width: 1px; border-right-color: #da532c; border-right-width: 3px; border-left-color: #da532c; border-left-width: 3px;">
                        ...
                        <a href="FactoryTransferDetails.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-color: #da532c; border-bottom-width: 3px;  border-right-color: #da532c; border-right-width: 3px; border-left-color: #da532c; border-left-width: 3px;">
                            <h6 class="list-group-item-heading" style="color: #da532c;">Factory Transfer Details</h6>
                        </a>
                ...
                <div class="col-sm-2 col-md-2 col-lg-2 ">
                    <div class="list-group" style="border-color: #da532c; color: whitesmoke">
                        ...
                        <a href="StockPositionReport.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-width: 1px; border-right-color: #da532c; border-right-width: 3px; border-left-color: #da532c; border-left-width: 3px;">
                          ...
                          <a href="PIPreAndPostCount.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-color: #da532c; border-bottom-width: 3px;  border-right-color: #da532c; border-right-width: 3px; border-left-color: #da532c; border-left-width: 3px;">
                            <h6 class="list-group-item-heading" style="color: #da532c;">PI Pre & Post Counts</h6>
                        </a>
