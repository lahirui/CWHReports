<%@ Page Language="C#"  MasterPageFile="~/MasterPages/WarehouseMaster.Master" AutoEventWireup="true" CodeBehind="GoodsReceivedDetailesStatus_NotReceived.aspx.cs" Inherits="PDCSReporting.GoodsReceivedDetailesStatus_NotReceived" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="page-header" style="padding-top:80px;">
            <h1 style="font-family: Georgia; color: #da532c;">Goods Received Status - Not Received</h1>
        </div>
        <div class="row">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #da532c;">
                    ...
                    <h3 class="modal-title" style="font-family: Georgia; color: white; font-weight: 500">Goods Received Status - Not Received</h3>
                </div>
