<%@ Page Title="CWH Reports" Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/WarehouseMaster.Master" CodeBehind="DailyScannedBoxes.aspx.cs" Inherits="PDCSReporting.DailyScannedBoxes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container-fluid">
        ...
        <div class="page-header" style="padding-top: 80px;">
            <h1 style="font-family: Georgia; color: #da532c">Daily Scanned Boxes Details - With CPO</h1>
        </div>
        ...
        <div class="row" style="padding-top: 20px; padding-bottom: 10px;">
            <div class="col-sm-12 col-md-12 col-lg-12" style="width: 100%;">
                <rsweb:ReportViewer ID="rvTeamOutput" SizeToReportContent="true" runat="server"></rsweb:ReportViewer>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#da532c;">
                    ...
                    <h3 class="modal-title" style="font-family: Georgia; color: white; font-weight: 500">Daily Scanned Boxes Details - With CPO</h3>
                </div>
