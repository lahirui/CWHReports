<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/WarehouseMaster.Master" CodeBehind="DailyScannedRFIDTags.aspx.cs" Inherits="PDCSReporting.DailyScannedRFIDTags" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container-fluid">
        ...
        <div class="page-header" style="padding-top: 80px;">
            <h1 style="font-family: Georgia; color: #da532c">Daily Scanned RFID Tags - Trim Stores</h1>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#da532c;">
                    ...
                    <h3 class="modal-title" style="font-family: Georgia; color: white; font-weight: 500">Daily Scanned RFID Tags - Trim Stores</h3>
                </div>
                            ...
                            <ContentTemplate>
                                <div class="form-group">
                                    ...
                                    <div class="form-inline col-sm-4 col-md-4 col-lg-4">
                                        ...
                                        <asp:Calendar ID="calToDate" runat="server" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Georgia" Font-Size="9pt" ForeColor="Black" Height="190px" NextPrevFormat="FullMonth" Width="250px" OnDayRender="calToDate_DayRender1">
                                            <DayHeaderStyle Font-Bold="True" Font-Size="8pt" />
                                            <NextPrevStyle Font-Bold="True" Font-Size="8pt" ForeColor="#333333" VerticalAlign="Bottom" />
                                            <OtherMonthDayStyle ForeColor="#999999" />
                                            <SelectedDayStyle BackColor="#da532c" ForeColor="White" />
