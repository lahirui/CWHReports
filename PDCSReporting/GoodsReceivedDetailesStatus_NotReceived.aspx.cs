...
{
    public partial class GoodsReceivedDetailesStatus_NotReceived : System.Web.UI.Page
    {
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportDesigns/GoodsReceivedStatus_NotReceived.rdlc");
            //GoodsReceivedStatusDS output = dba.getGoodsReceivedStatus(dateFrom, dateTo, fromFactory, toFactory, fromAOD, toAOD, fromCPO, toCPO, factoryName);
            DataTable output = dba.getGoodsReceivedStatus_NotReceived(fromFactory, toFactory, fromAOD, toAOD, fromCPO, toCPO, factoryName);

            ReportDataSource ds = new ReportDataSource("GoodsReceivedStatusDS", output);
