<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/WarehouseMaster.Master" AutoEventWireup="true" CodeBehind="CartonWiseStockReport.aspx.cs" Inherits="PDCSReporting.CartonWiseStockReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function openMyModal() {
            $('#CartonWiseStockReportModal').modal('show');
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="page-header" style="padding-top: 80px;">
            <h1 style="font-family: Georgia; color: #da532c;">Carton Wise Stock Report</h1>
        </div>
        <div class="row">
            <div class="col-sm-2 col-md-2 col-lg-2">
                <button type="button" id="generateReportBtn" class="btn btn-success btn-lg" data-toggle="modal" data-target="#CartonWiseStockReportModal">Setup Report</button>
            </div>
        </div>
    ...
    <%-- Modal --%>
    <div id="CartonWiseStockReportModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #da532c;">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h3 class="modal-title" style="font-family: Georgia; color: white; font-weight: 500">Carton Wise Stock Report</h3>
                </div>
