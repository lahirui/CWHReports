...
{
    public partial class GoodsReceivedDetailesStatus : System.Web.UI.Page
    {
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportDesigns/GoodsReceivedStatus.rdlc");
            ...
            DataTable output = dba.getGoodsReceivedStatus(dateFrom, dateTo, fromFactory, toFactory, fromAOD, toAOD, fromCPO, toCPO, factoryName);
