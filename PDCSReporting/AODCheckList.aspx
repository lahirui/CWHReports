<%@ Page Language="C#" MasterPageFile="~/MasterPages/WarehouseMaster.Master" AutoEventWireup="true" CodeBehind="AODCheckList.aspx.cs" Inherits="PDCSReporting.AODCheckList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="page-header" style="padding-top:80px;">
            <h1 style="font-family: Georgia; color: #da532c;">AOD Check List</h1>
        </div>
        <div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #da532c;">
                    ...
                    <h3 class="modal-title" style="font-family: Georgia; color: white; font-weight: 500">AOD Check List</h3>
                </div>
                            ...
                            <div class="form-horizontal" role="form">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <asp:DropDownList ID="ddlAodNumbers" runat="server" AutoPostBack="true" AppendDataBoundItems="true" CssClass="form-control" OnSelectedIndexChanged="ddlAodNumbers_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </ContentTemplate>
